...
#define  OS_ENTER_CRITICAL()  asm tfr ccrw,d;asm sei;asm std cpu_sr    /* Disable interrupts                        */

//#define  OS_EXIT_CRITICAL()   (OS_CPU_SR_Restore(cpu_sr))    /* Enable  interrupts                        */
#define  OS_EXIT_CRITICAL()   asm ldd cpu_sr;asm tfr d,ccrw    /* Enable  interrupts                        */
#endif
...
*/
//#if      OS_CRITICAL_METHOD == 3
//OS_CPU_SR  OS_CPU_SR_Save(void);                    /* Return the value of the CCR register and then ...  */
                                                    /* ... disable interrupts via SEI instruction.        */
//void       OS_CPU_SR_Restore(OS_CPU_SR os_cpu_sr);  /* Set CCR register to 'os_cpu_sr'                    */
//#endif
#endif
