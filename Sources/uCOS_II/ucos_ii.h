...
//INT8U  volatile OSUnMapTbl[256];
OS_EXT INT8U  volatile OSRdyGrp;
OS_EXT INT8U  volatile OSRdyTbl[OS_RDY_TBL_SIZE];
OS_EXT OS_TCB volatile *OSTCBCur;
OS_EXT OS_TCB volatile *OSTCBFreeList;
OS_EXT OS_TCB volatile *OSTCBHighRdy;
OS_EXT OS_TCB volatile *OSTCBList;
OS_EXT OS_TCB volatile *OSTCBPrioTbl[OS_LOWEST_PRIO+1];
OS_EXT OS_TCB volatile OSTCBTbl[OS_MAX_TASKS+OS_N_SYS_TASKS];
