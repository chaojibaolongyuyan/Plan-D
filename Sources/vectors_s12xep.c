...
extern void near CAN0RX_Handler(void);              //CAN0接收中断函数
extern void near CAN1RX_Handler(void);              //CAN1接收中断函数
extern void near IOC0_Handler(void);                //IOC0中断函数
extern void near IOC4_Handler(void);                //IOC4中断函数
extern void near IOC1_Handler(void);                //IOC1中断函数
extern void near IOC5_Handler(void);                //IOC5中断函数
extern void near IOC3_Handler(void);                //IOC3中断函数
extern void near IOC7_Handler(void);                //IOC7中断函数
extern void near IOC2_Handler(void);                //IOC2中断函数
extern void near IOC6_Handler(void);                //IOC6中断函数
...
const tIsrFunc _vect[] @0xFF10 = {
        ...
        IOC7_Handler,                  /* 0xE0: Standard Timer Channel 7. Generally    */
                                       /* used for OS Tick interrupt and uC/Probe      */

        IOC6_Handler,
        //software_trapE2,               /* 0xE2: Standard Timer Channel 6               */
        IOC5_Handler,                  /* 0xE4: Standard Timer Channel 5               */
        IOC4_Handler,                  /* 0xE6: Standard Timer Channel 4               */
        IOC3_Handler,                  /* 0xE8: Standard Timer Channel 3               */        
        //software_trapEA,               /* 0xEA: Standard Timer Channel 2               */
        IOC2_Handler,
        IOC1_Handler,                  /* 0xEC: Standard Timer Channel 1               */
        IOC0_Handler,                  /* 0xEE: Standard Timer Channel 0               */ 
                       
        OSTickISR,                     /* 0xF0: Real-Time Interrupt                    */
        software_trapF2,               /* 0xF2: IRQ                                    */
        software_trapF4,               /* 0xF4: XIRQ                                   */

						     
        OSCtxSw,                       /* 0xF6: SWI - Used for OS Context Switch       */

        software_trapF8,               /* 0xF8: Unimplemented Instruction Trap         */
        _Startup,                      /* 0xFA: COP Watchdog Timeout                   */
        _Startup,                      /* 0xFC: Clock Monitor Fail                     */
